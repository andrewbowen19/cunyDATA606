...
LaGuardia (LGA) has the hightest rate of on-time departures (72.8% of departing flights on-time), so we'll want to choose there if we want the best chance of leaving on time
* * *
