...
Our TV viewership data for the 2010 World Cup swas collected into a csv file by FiveThirtyEight. The original csv file lives in their GitHub repo [here](https://github.com/fivethirtyeight/data/tree/master/fifa). The original file contains 5 fields: 
- `country`
- `confederation`
- `tv_audience_share`
- `population_share`
